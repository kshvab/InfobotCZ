...
function publishtransportationInitiation(msg) {
  ...
  dbUser.findOne({ telegramUserId: chatId }, function(err, person) {
    ...
    if (!person) {
      ...
      let transportationContactPermissionText = strings(language)
      ...
      bot.sendMessage(chatId, transportationContactPermissionText, opts);
    }
  });
}
module.exports = publishtransportationInitiation;
